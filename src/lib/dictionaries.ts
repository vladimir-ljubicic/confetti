...
const en = {
  ...
  myPhotos: {
    ...
    photoAlt: "Photo",
    recoveryTitle: "Transfer code",
    recoveryHint: "Save this code if you change phones.",
    recoveryCopy: "Copy",
  ...
  introSheet: {
    ...
    recoverLink: "Already uploaded?",
  },
  recovery: {
    title: "Bring your photos over",
    explainerLine1: "Enter the code from your old phone.",
    explainerLine2: "Your photos and your name come with it.",
    codeLabel: "Code",
    submit: "Bring them over",
    cancel: "Cancel",
    unknown: "No such code — check it once more",
...
const sr: Dictionary = {
  ...
  myPhotos: {
    ...
    photoAlt: "Фотографија",
    recoveryTitle: "Код за пренос",
    recoveryHint: "Сачувајте овај код ако мењате телефон.",
  ...
  introSheet: {
    ...
    recoverLink: "Већ сте отпремали?",
  },
  recovery: {
    title: "Пренесите своје фотографије",
    explainerLine1: "Унесите код са старог телефона.",
    explainerLine2: "Ваше фотографије и име прелазе овде.",
    codeLabel: "Код",
    submit: "Пренеси",
    cancel: "Откажи",
    unknown: "Тај код не постоји — проверите га још једном",
    rateLimited: "Превише покушаја — сачекајте пар минута",
    failed: "Није успело — покушајте поново",
  },
  admin: {
