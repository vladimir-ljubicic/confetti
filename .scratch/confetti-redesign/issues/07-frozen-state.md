...
- [ ] Notice card sticky under compact bar, copy per README
- [ ] Secondary button style: `#fffdf8` fill, hairline border, `#8a6d2c` label
- [ ] Uses existing `uploads_frozen` flag (auto-set 7 days after event — issue 18);
      masthead behaviour identical to 1a
- [ ] Button resolves the public zip via the stable `GET /api/export/public` endpoint;
